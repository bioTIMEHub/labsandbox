...
#plot arrows
arrows(x0 = 33, y0 = bothIntermediate$predOrderNb, x1 = 51, y1 = bothIntermediate$predOrderNa, length = 0.001)


#plotting text 
text(x = 52, y = bothIntermediate$predOrderNa, labels = bothIntermediate$Group.1, adj = c(0,NA))
text(x = 32, y = bothIntermediate$predOrderNb, labels = bothIntermediate$Group.1, adj = c(1,NA))
