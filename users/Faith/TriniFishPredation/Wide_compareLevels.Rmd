...
#plot arrows
arrows(x0 = 35, y0 = WideBoth$predOrderNb, x1 = 49, y1 = WideBoth$predOrderNa, length = 0.001)


#plotting text 
text(x = 54, y = WideBoth$predOrderNa, labels = WideBoth$Group.1)
text(x = 30, y = WideBoth$predOrderNb, labels = WideBoth$Group.1)
