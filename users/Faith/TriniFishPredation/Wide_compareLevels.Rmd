...
Wideb <- aggregate(FishDataTot$PropMass, list(FishDataTot$site), mean, na.rm=TRUE)
...
#plot arrows
arrows(x0 = 33, y0 = WideBoth$predOrderNb, x1 = 51, y1 = WideBoth$predOrderNa, length = 0.001)


#plotting text 
text(x = 52, y = WideBoth$predOrderNa, labels = WideBoth$Group.1, adj = c(0,NA))
text(x = 32, y = WideBoth$predOrderNb, labels = WideBoth$Group.1, adj = c(1,NA))
