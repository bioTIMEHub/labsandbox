...
Narrow <- aggregate(FishDataTot$BiomassSum, list(FishDataTot$site), mean, na.rm=TRUE)
...
plotSetup <- data.frame(cbind(c(1:17),c(20:110))) # data to plot onto emptyp plot
...
arrows(x0 = 74, y0 = orderNMW$predOrderM, x1 = 94, y1 = orderNMW$predOrderW, length = 0.001)


#plotting text 
text(x = 34, y = orderNMW$predOrderN, labels = orderNMW$Group.1, adj = c(1,NA))
text(x = 65, y = orderNMW$predOrderM, labels = orderNMW$Group.1)
text(x = 95, y = orderNMW$predOrderW, labels = orderNMW$Group.1, adj = c(0,NA))

text(x = 30, y = 17, labels = "Narrow", cex = 1.5)
text(x = 64, y = 17, labels = "Intermediate", cex = 1.5)
text(x = 100, y = 17, labels = "Broad", cex = 1.5)
