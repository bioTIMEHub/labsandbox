...
#plot slopes of each sites using Lm

NarrowBiomass <- ggplot(aes(x = Year, y = LogBiomass, colour = site),data = FishDataTot)
NarrowBiomass + 
  geom_smooth(se = FALSE, method = "lm")+ 
	theme_classic()+
	labs(y = "Log Predator Biomass (kg)")
...
#plot slopes not from the mixed model

NarrowBiomass <- ggplot(aes(x = Year, y = LogBiomass, colour = site),data = FishDataTotm)
NarrowBiomass + 
  geom_smooth(se = FALSE, method = "lm")+ 
	theme_classic()+
	labs(y = "Log Predator Biomass (kg)")
...
```{r}
NarrowBiomass <- ggplot(aes(x = Year, y = LogBiomass, colour = site),data = FishDataTotw)
NarrowBiomass + 
  geom_smooth(se = FALSE, method = "lm")+ 
	theme_classic()+
	labs(y = "Log Predator Biomass (kg)")
