...
#plot arrows
arrows(x0 = 33, y0 = bothNarrow$predOrderNb, x1 = 51, y1 = bothNarrow$predOrderNa, length = 0.001)


#plotting text 
text(x = 52, y = bothNarrow$predOrderNa, labels = bothNarrow$Group.1, adj = c(0,NA))
text(x = 32, y = bothNarrow$predOrderNb, labels = bothNarrow$Group.1, adj = c(1,NA))
