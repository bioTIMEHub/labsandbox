...
predatorsNarrowSC <- merge(predatorsNM, siteCodes, by.x = "site", by.y = "siteNames") #add site codes 
...
predatorIntSC <- merge(predatorsIM, siteCodes, by.x = "site", by.y = "siteNames") #add site codes 
...
predatorWideSC <- merge(predatorsWM, siteCodes, by.x = "site", by.y = "siteNames") #add site codes 
